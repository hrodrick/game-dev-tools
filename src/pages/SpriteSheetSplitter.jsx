  ...
  return (
    <div>
      <div style={{ display: 'flex', alignItems: 'flex-start', gap: 32, marginBottom: 12 }}>
        ...
        <div style={{ flex: 1 }}>
          ...
          {image && (
            <>
              ...
              <div style={{ margin: '8px 0 18px 0', position: 'relative', display: 'inline-block', maxWidth: '100%', minWidth: 320, minHeight: 120 }}>
                <img
                  ref={imgRef}
                  src={image}
                  alt="sprite sheet"
                ...
                />
                <GridOverlay
                  cellWidth={splitMode === 'size' ? parseInt(cellWidth, 10) || 1 : (columns ? Math.floor(imgInfo?.width / columns) : 1)}
                  cellHeight={splitMode === 'size' ? parseInt(cellHeight, 10) || 1 : (rows ? Math.floor(imgInfo?.height / rows) : 1)}
                  imgRef={imgRef}
                  splitMode={splitMode}
                  columns={columns}
                  rows={rows}
        ...
        {/* Right: Controls */}
        <div style={{ minWidth: 250, maxWidth: 340, display: 'flex', flexDirection: 'column', gap: 18 }}>
          {/* Split Mode */}
          ...
          <div style={{ marginBottom: 8 }}>
            {splitMode === 'size' ? (
              <>
                <div style={{ marginBottom: 8 }}>
                  <label style={{ marginRight: 8, fontWeight: 500 }} htmlFor="cellWidth">Width</label>
                  <input
                    id="cellWidth"
                    type="number"
                    min={1}
                ...
                <div>
                  <label style={{ marginRight: 8, fontWeight: 500 }} htmlFor="cellHeight">Height</label>
                  <input
                    id="cellHeight"
                    type="number"
                    min={1}
              ...
              <>
                <div style={{ marginBottom: 8 }}>
                  <label style={{ marginRight: 8, fontWeight: 500 }} htmlFor="columns">Columns</label>
                  <input
                    id="columns"
                    type="number"
                    min={1}
                ...
                <div>
                  <label style={{ marginRight: 8, fontWeight: 500 }} htmlFor="rows">Rows</label>
                  <input
                    id="rows"
                    type="number"
                    min={1}
          ...
          <div style={{ marginBottom: 8 }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
              <div>
                <label style={{ marginRight: 8, fontWeight: 500 }} htmlFor="paddingLeft">Left</label>
                <input
                  id="paddingLeft"
                  type="number"
                  min={0}
              ...
              <div>
                <label style={{ marginRight: 8, fontWeight: 500 }} htmlFor="paddingRight">Right</label>
                <input
                  id="paddingRight"
                  type="number"
                  min={0}
              ...
              <div>
                <label style={{ marginRight: 8, fontWeight: 500 }} htmlFor="paddingTop">Top</label>
                <input
                  id="paddingTop"
                  type="number"
                  min={0}
              ...
              <div>
                <label style={{ marginRight: 8, fontWeight: 500 }} htmlFor="paddingBottom">Bottom</label>
                <input
                  id="paddingBottom"
                  type="number"
                  min={0}
